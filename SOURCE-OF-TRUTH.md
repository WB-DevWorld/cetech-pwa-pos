...
ADRs 001–010 encode the initial authorized baseline; subsequent approved ADRs refine it. ADR-012 controls approved batch continuation and bounded freshness once adopted through R1. Deployment/business evidence is recorded with its verification level in LIVE-ENVIRONMENT-FACTS.md; unconfirmed fields remain UNVERIFIED. The upstream Transfer Kit v1.0.1 remains shared methodology, not a competing project constitution. Its duplicated generic priority lists yield to this explicit project hierarchy. Raw chats and broad user knowledge are not copied into Git.
