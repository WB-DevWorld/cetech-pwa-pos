...
| R2 | Authentication, bridge health and BFF | BR-01, CORE-02, CORE-03 | [#43](https://github.com/WB-DevWorld/cetech-pwa-pos/pull/43) DRAFT `batch/r2-auth-bridge-bff` (BR-01 not imported) | CORE-02 negative auth tests CHECKPOINTED. CORE-03 PREP_ONLY BFF health mocks; no live Woo/bridge; no browser secrets. R2 gate not passed while BR-01 is uncombined. |
