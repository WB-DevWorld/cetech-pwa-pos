...
| R2 | Authentication, bridge health and BFF | BR-01, CORE-02, CORE-03 | [#43](https://github.com/WB-DevWorld/cetech-pwa-pos/pull/43) DRAFT `batch/r2-auth-bridge-bff` (BR-01 not imported) | CORE-02 acceptance remediation in progress (roles, mandatory mutation protection, Supabase Auth adapter). CORE-03 PREP_ONLY until combined BR-01. R2 gate not passed. |
