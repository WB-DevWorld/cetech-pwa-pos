...
CP-04 dependency interpretation: [ADR-011](../decisions/ADR/011.md). Its development baseline is SATISFIED. CORE-01 is ACCEPTED through R1/`aa08d74f…`. R2/#43 is APPROVED / MERGED / VERIFIED at `ab9aa5ae3dcc79d51efb22c19bd1f17f38d57f77` (post-merge CI run 34765462210). BR-01 exact SHA `280a73d…` is on main (INTEGRATED_AND_TESTED / LIVE WORDPRESS HEALTH VERIFIED via CP-04 `67ea42c…` / `edf24af…`). CORE-02 COMPLETE FOR R2. CORE-03 LIVE RUNTIME ACCEPTED. R3/#44 is APPROVED / MERGED / POST-MERGE VERIFIED at `516d6a49af74cc6677f67bdf843de6e819a05feb` (post-merge CI run 34778771391). ADR-013 accepted through that reviewed merge. Training plugin `0.2.7-br02`; frozen v1 `pricingParityVerified` remains false. Issue #4 stays OPEN. R4 is assembled on existing PR #41 (CORE-04 → FE-03 → FE-04) and is **AWAITING INDEPENDENT RE-REVIEW** after Emmanuel merge-blocker remediation; not merged from this editor. Do not start R5 from this index. W1 PASS on training; W4 PASS on training WordPress side. Overall CP-04 is not complete. An open tracker is not a blanket dependency failure. [Remaining actions](../runbooks/CP-04-REMAINING-WORK.md).
