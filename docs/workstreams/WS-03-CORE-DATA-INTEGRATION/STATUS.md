...
Additive `ReceiptLine.displayName`/`sku`, `ReceiptSettings`, sale-time catalog presentation snapshot, `pos_receipt_settings`. Compact POS wrapping remains WS1. Remote staging apply UNVERIFIED; local Docker Postgres additive migration applied.
