...
Staging plugin/runtime versions were supplied as user-reported Site Health facts on 2026-09-12. Critical unknowns remain: runtime compatibility and pricing behavior, HPOS authority, VitePOS stock mode, barcode mapping, tax process, provider account and hardware. See LIVE-ENVIRONMENT-FACTS.md. Pricing parity and concurrent last-unit stock proof gate real checkout. No current deployment is implied by this document.
