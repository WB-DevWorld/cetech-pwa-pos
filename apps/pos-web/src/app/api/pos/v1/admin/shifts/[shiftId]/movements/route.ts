...
import { handleListManagementCashMovements } from "@/server/admin/handle-management-cash-correction";
...
export async function GET(
  ...
  try {
    ...
    const result = await handleListManagementCashMovements({
    ...
    const result = {
      ...
      error: {
        ...
        message: "cash movements are unavailable",
        retryable: true,
