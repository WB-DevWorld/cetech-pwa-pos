...
| BR-02 | WS2 / @Emmanuel-coder-prog; R3 editor @wbdevworld | batch/r3-authoritative-pricing-parity | LOCAL MAPPING DEFECT FIXED; live PERMISSION_REQUIRED (issue #14) | Isolated Woo runtime quote on this branch. Production `unitPrice` subtotal bug corrected locally (`0.2.1-br02`); not live-complete. Training `/quotes` still `rest_no_route`. R3 plugin update PERMISSION_REQUIRED | QuoteRequest, Quote, ApiFailure v1.0.0 | R3 first |
| BR-03 | WS2 | batch/r3-authoritative-pricing-parity | LOCAL HARNESS COMPLETE; live PARITY PERMISSION_REQUIRED (issue #15) | No invented WoodMart thresholds. Live training capture PERMISSION_REQUIRED | Quote v1.0.0; pricing corpus | R3 after BR-02 |
| BR-04 | WS2 | batch/r3-authoritative-pricing-parity | LOCAL HARNESS COMPLETE; live PARITY PERMISSION_REQUIRED (issue #16) | Unconfigured = NOT_APPLICABLE_WITH_EVIDENCE. Live capture PERMISSION_REQUIRED | CustomerContext, Quote v1.0.0 | R3 after BR-02 |
| BR-05 | WS2 | batch/r3-authoritative-pricing-parity | LOCAL OVERLAP HARNESS; PRICING GATE NOT PASSED (issue #17) | Live overlap matrix PERMISSION_REQUIRED. Unexplained live mismatch BLOCKS R3 | Quote/error v1.0.0; pricing matrix | R3 last |
