...
| BR-02 | WS2 / @Emmanuel-coder-prog; R3 editor @wbdevworld | batch/r3-authoritative-pricing-parity | LIVE RETAIL MATCH; guest REFUSAL_MATCH (issue #14) | Isolated Woo quote on training `0.2.3-br02`. Guest cannot purchase (B2BKing). Not pricing-gate PASS | QuoteRequest, Quote, ApiFailure v1.0.0 | R3 first |
| BR-03 | WS2 | batch/r3-authoritative-pricing-parity | LIVE WOODMART 19/20/21 MATCH (issue #15) | Configured from-qty 20; empty to-qty. No invented thresholds | Quote v1.0.0; pricing corpus | R3 after BR-02 |
| BR-04 | WS2 | batch/r3-authoritative-pricing-parity | LIVE B2B CONTEXT MATCH; extra types N/A (issue #16) | Cart-total rules present; no distinct vs-retail total on captured cart. Kind switch 403 | CustomerContext, Quote v1.0.0 | R3 after BR-02 |
| BR-05 | WS2 | batch/r3-authoritative-pricing-parity | LIVE OVERLAP MATCH; PRICING GATE NOT PASSED (issue #17) | Guest priced path absent; tax-off N/A. `pricingParityVerified` false | Quote/error v1.0.0; pricing matrix | R3 last |
