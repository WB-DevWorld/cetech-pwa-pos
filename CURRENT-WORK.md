...
| BR-02 | WS2 / @Emmanuel-coder-prog; R3 editor @wbdevworld | batch/r3-authoritative-pricing-parity | READY (issue #14) | BR-01 accepted through R2. Isolated Woo runtime quote. No provider formula copy. Live training plugin update PERMISSION_REQUIRED | QuoteRequest, Quote, ApiFailure v1.0.0 | R3 first |
| BR-03 | WS2 | batch/r3-authoritative-pricing-parity | READY after tested BR-02 (issue #15) | BR-02. WoodMart quantity/tier parity from actual configured runtime. Do not invent thresholds | Quote v1.0.0; pricing corpus | R3 after BR-02 |
| BR-04 | WS2 | batch/r3-authoritative-pricing-parity | READY after tested BR-02 (issue #16) | BR-02. B2BKing commercial parity from actual configured runtime. Unconfigured = NOT_APPLICABLE_WITH_EVIDENCE | CustomerContext, Quote v1.0.0 | R3 after BR-02 |
| BR-05 | WS2 | batch/r3-authoritative-pricing-parity | BLOCKED until BR-03 and BR-04 tested (issue #17) | BR-03 + BR-04. Exercise WoodMart+B2BKing together. Unexplained minor-unit mismatch BLOCKS R3 | Quote/error v1.0.0; pricing matrix | R3 last |
