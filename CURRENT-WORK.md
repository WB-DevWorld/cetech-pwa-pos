...
| CORE-04 | WS3 / @wbdevworld | `ws3/core-04-implement-catalog-projection-and-durable-loca`; imported into #41 only as declared tested SHAs | IN PROGRESS (issue #23) | Isolated worktree from R3 main `516d6a49…`. CatalogPort, CartDraftStore, OperationJournal v1.0.0 frozen unless a genuine contract defect is found | CatalogPort, CartDraftStore, OperationJournal v1.0.0 | R4 first |
| FE-03 | @Ben-001-sys / WS1; R4 editor @wbdevworld | PR #41 `ws1/fe-03-build-sell-cart-barcode-and-customer-workflow` | PREPARATION preserved; RUNTIME pending CORE-04 import (issue #8) | Six preparation commits retained. Isolated WS1 continuation after CORE-04 `INTEGRATED_AND_TESTED`. Do not recreate FE-01/FE-02 | CatalogPort, CustomerPort, CartDraftStore v1.0.0 | R4 after CORE-04 |
| FE-04 | @Ben-001-sys / WS1; R4 editor @wbdevworld | same #41 after FE-03 combined pass | QUOTE-STATE pending FE-03 runtime (issue #9) | R3/BR-05 pricing gate is present on main; `pricingParityVerified` false. No sale/payment effects | PricingPort, QuoteState, CheckoutEligibility v1.0.0 | R4 last |
...
- Batch / milestone: **R4**, ordered tasks CORE-04, then FE-03, then FE-04. One R4 PR: existing draft **#41**. Independent reviewer: **@Ben-001-sys**. No self-merge. WS1 owner: @Ben-001-sys.
...
- CORE-04 contributor worktree: `C:\Users\Jane\Desktop\Learning 2026\Cursor\cetech-pwa-pos-ws3-core-04` from `516d6a49…`.
