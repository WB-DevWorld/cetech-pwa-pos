...
After this checkpoint: WS3 remediation branch `ws3/r6-rem-01-durable-runtime` from the published authority SHA. Then tested source → import onto `batch/r6-first-real-cash-sale`.
...
DURABLE POS RUNTIME GATE: IN_PROGRESS (R6-REM-01)
ISOLATED STAGING REAL-SALE GATE: BLOCKED (await durable runtime)
```
