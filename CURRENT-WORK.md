...
- Neutral R6 head this lease is recorded against: `eac32cdff60f0f6ed80bb0908f9091543c859ead` (lease recording). Later rem/import/sale SHAs are below.
...
ISOLATED STAGING REAL-SALE GATE: PASS
R6 FINAL ACCEPTANCE EVIDENCE: COMPLETE
```
